...
\node[class, right=3.5cm of bat] (spec) {Specification};
\node[class, below left=1.6cm and 0.0cm of bat] (mfr) {Manufacturer};
\node[class, below right=1.6cm and 0.0cm of bat] (chem) {Chemistry};
